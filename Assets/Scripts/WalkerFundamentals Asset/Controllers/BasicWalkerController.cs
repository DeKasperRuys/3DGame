...
public class BasicWalkerController : MonoBehaviour {
	...
	void HandleJumpKeyInput()
	{
        ...
        if (sprintKeyIsPressed == false && _newSprintKeyPressedState == true)
        {
            sprintKeyIsPressed = _newSprintKeyPressedState;
        }
    ...
    // returns 'true' if the player presser the sprint key;
